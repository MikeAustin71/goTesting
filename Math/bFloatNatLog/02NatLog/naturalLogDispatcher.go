...
func (nlogDispatcher *NaturalLogDispatcher) Compute(x *big.Float, workingBFloatPrec uint) (*big.Float, error) {
	...
	return new(naturalLogTaylor).lnTaylorDirect(x, workingBFloatPrec)
}
