...
func (ia *IntAry) addToSubtractFromThis(ia2 *IntAry, newSignVal int, doAdd bool, isZeroResult bool, doReverseNums bool, convertToNumStr bool) error {
	...
	if isZeroResult {
		_ = ia.SetIntAryToZero(ia.Precision)
		return nil
	}
...
/*
func (ia *IntAry) SetIntAryWithInt64(intDigits int64, precision int, signVal int) error {
...
func (ia *IntAry) SetIntAryWithIntAry(iAry2 []int, precision int, signVal int) error {

	if precision < 0 {
		return fmt.Errorf("SetIntAryWithIntAry() - Error: precision parameter is less than ZERO! precision='%v'", precision)
	}
