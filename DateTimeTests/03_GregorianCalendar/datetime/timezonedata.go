...
// time zones. These data elements classify time zones by geographic region
// and type. For example, classifications like, 'America', 'Asia' and 'Europe'
// provide access to zones located in those geographic regions. The 'Military'
// classification provides access to time zones used exclusively by military,
// aviation or maritime organizations.
// 
...
//          Other Non-Iana Time Zones :   1  ('Local' Time Zone)
//                                         -------
//                          Total Time Zones: 619
// 
...
// Local - Returns the local time zone on the host computer where this
// code is executed.
// 
// For documentation, reference:
//    https://golang.org/pkg/time/#LoadLocation
// 
func(tZones TimeZones) Local() string {return "Local"}


// UCT - A time zone equivalent to Coordinated Universal Time. 
// Coordinated Universal Time is the primary time standard by which the world regulates
// regulates clocks and time. It is within about 1 second of mean solar time at 0°
// longitude, and is not adjusted for daylight saving time. In some countries, the
// term Greenwich Mean Time is used.
 // 
...
// Coordinated Universal Time (or UTC) is the primary time standard by which the
// world regulates clocks and time. It is within about 1 second of mean solar time
// at 0° longitude, and is not adjusted for daylight saving time. In some countries,
// the term Greenwich Mean Time is used.
 // 
...
// This time zone is a military time zone. // 
// Zulu Time Zone is often used in aviation and the military as another name for UTC +0.
// Zulu Time Zone is also commonly used at sea between longitudes 7.5° West and 7.5° East.
// The letter Z may be used as a suffix to denote a time being in the Zulu Time Zone,
// such as 08:00Z or 0800Z. This is spoken as "zero eight hundred Zulu".
// 
// The US Military, Chinese Military, and several others have adopted a unique list of
// names for the time zones across the world. The names use the NATO phonetic alphabet which
// calls for the 26 letters of the alphabet to be designated by easily recognizable words.
// The Zulu time zone is one of these.
// 
...
// TimeZoneUtcOffsetReference - Provides thread safe access to
// all Time Zone zone names and their associated UTC offsets.
//  
type TimeZoneUtcOffsetReference struct {
	Input                  string
	Output                 string
}

// GetTimeZoneUtcOffsets - Returns a pair of UTC offsets as a string
// array consisting of two elements. These two UTC offsets are associated
// with the time zone specified in input parameter string, 'timeZoneName'.
// The first UTC offset shows the hours and minutes of offset from UTC
// time on June 15th of the current year. The second UTC offset shows
// the hours and minutes of offset from UTC time on December 31st of
// the current year. If the two UTC offsets are equivalent, it signals
// that day light savings time is not applied to the specified time zone.
// 
// The two returned UTC offset strings are formatted as shown in the
// following examples: 
//      UTC+1030
//      UTC-0500
//      UTC+0400
//      UTC-0400
//  
// The lookup operation is performed using thread safe access to the
// map, 'mapAllTimeZonesToUtcOffsets'.
//  
func(tzUtcOffset TimeZoneUtcOffsetReference) GetTimeZoneUtcOffsets(
  timeZoneName string) ([]string, error) {

  lockMapAllTimeZonesToUtcOffsets.Lock()
  ...
  testStr := strings.ToLower(timeZoneName)

  if testStr == "local"{

    tNow := time.Now().In(time.Local)
    ...
    tJuneStr := tJune.Format("2006-01-02 15:04:05 -0700 MST")

    tDecemberStr := tDecember.Format("2006-01-02 15:04:05 -0700 MST")

    lenLeadStr := len("2006-01-02 15:04:05 ")

    utcArray[0] = "UTC" + tJuneStr[lenLeadStr: lenLeadStr + 5] 

    utcArray[1] = "UTC" + tDecemberStr[lenLeadStr: lenLeadStr + 5] 

    return utcArray, nil
  }

  utcArray, ok := mapAllTimeZonesToUtcOffsets[timeZoneName]

  if !ok {
    return make([]string, 2), fmt.Errorf(ePrefix + 
...
// valid time zones and their associated UTC offsets. These UTC
// offsets are contained in a returned string array containing
// a pair of UTC offsets. The returned string array consists of
// two array elements. The first array element contains the UTC
// offset calculated for June 15th of the current year. The
// second UTC offset is calculated for December 15th of the
// current year.  If the two UTC offsets are equivalent, it
// signals that daylight savings time is not applied in the
// time zone.
//  
// Returned UTC offset strings are formatted in accordance with
// following examples: 
//      UTC+1030
//      UTC-0500
//      UTC+0400
...
var lockMapAllTimeZonesToUtcOffsets sync.Mutex

var mapAllTimeZonesToUtcOffsets = map[string][]string{
  "Africa/Abidjan"                     : { "UTC+0000", "UTC+0000"},
  "Africa/Accra"                       : { "UTC+0000", "UTC+0000"},
  "Africa/Addis_Ababa"                 : { "UTC+0300", "UTC+0300"},
  "Africa/Algiers"                     : { "UTC+0100", "UTC+0100"},
  "Africa/Asmara"                      : { "UTC+0300", "UTC+0300"},
  "Africa/Asmera"                      : { "UTC+0300", "UTC+0300"},
  "Africa/Bamako"                      : { "UTC+0000", "UTC+0000"},
  "Africa/Bangui"                      : { "UTC+0100", "UTC+0100"},
  "Africa/Banjul"                      : { "UTC+0000", "UTC+0000"},
  "Africa/Bissau"                      : { "UTC+0000", "UTC+0000"},
  "Africa/Blantyre"                    : { "UTC+0200", "UTC+0200"},
  "Africa/Brazzaville"                 : { "UTC+0100", "UTC+0100"},
  "Africa/Bujumbura"                   : { "UTC+0200", "UTC+0200"},
  "Africa/Cairo"                       : { "UTC+0200", "UTC+0200"},
  "Africa/Casablanca"                  : { "UTC+0100", "UTC+0100"},
  "Africa/Ceuta"                       : { "UTC+0200", "UTC+0100"},
  "Africa/Conakry"                     : { "UTC+0000", "UTC+0000"},
  "Africa/Dakar"                       : { "UTC+0000", "UTC+0000"},
  "Africa/Dar_es_Salaam"               : { "UTC+0300", "UTC+0300"},
  "Africa/Djibouti"                    : { "UTC+0300", "UTC+0300"},
  "Africa/Douala"                      : { "UTC+0100", "UTC+0100"},
  "Africa/El_Aaiun"                    : { "UTC+0100", "UTC+0100"},
  "Africa/Freetown"                    : { "UTC+0000", "UTC+0000"},
  "Africa/Gaborone"                    : { "UTC+0200", "UTC+0200"},
  "Africa/Harare"                      : { "UTC+0200", "UTC+0200"},
  "Africa/Johannesburg"                : { "UTC+0200", "UTC+0200"},
  "Africa/Juba"                        : { "UTC+0300", "UTC+0300"},
  "Africa/Kampala"                     : { "UTC+0300", "UTC+0300"},
  "Africa/Khartoum"                    : { "UTC+0200", "UTC+0200"},
  "Africa/Kigali"                      : { "UTC+0200", "UTC+0200"},
  "Africa/Kinshasa"                    : { "UTC+0100", "UTC+0100"},
  "Africa/Lagos"                       : { "UTC+0100", "UTC+0100"},
  "Africa/Libreville"                  : { "UTC+0100", "UTC+0100"},
  "Africa/Lome"                        : { "UTC+0000", "UTC+0000"},
  "Africa/Luanda"                      : { "UTC+0100", "UTC+0100"},
  "Africa/Lubumbashi"                  : { "UTC+0200", "UTC+0200"},
  "Africa/Lusaka"                      : { "UTC+0200", "UTC+0200"},
  "Africa/Malabo"                      : { "UTC+0100", "UTC+0100"},
  "Africa/Maputo"                      : { "UTC+0200", "UTC+0200"},
  "Africa/Maseru"                      : { "UTC+0200", "UTC+0200"},
  "Africa/Mbabane"                     : { "UTC+0200", "UTC+0200"},
  "Africa/Mogadishu"                   : { "UTC+0300", "UTC+0300"},
  "Africa/Monrovia"                    : { "UTC+0000", "UTC+0000"},
  "Africa/Nairobi"                     : { "UTC+0300", "UTC+0300"},
  "Africa/Ndjamena"                    : { "UTC+0100", "UTC+0100"},
  "Africa/Niamey"                      : { "UTC+0100", "UTC+0100"},
  "Africa/Nouakchott"                  : { "UTC+0000", "UTC+0000"},
  "Africa/Ouagadougou"                 : { "UTC+0000", "UTC+0000"},
  "Africa/Porto-Novo"                  : { "UTC+0100", "UTC+0100"},
  "Africa/Sao_Tome"                    : { "UTC+0000", "UTC+0000"},
  "Africa/Timbuktu"                    : { "UTC+0000", "UTC+0000"},
  "Africa/Tripoli"                     : { "UTC+0200", "UTC+0200"},
  "Africa/Tunis"                       : { "UTC+0100", "UTC+0100"},
  "Africa/Windhoek"                    : { "UTC+0200", "UTC+0200"},
  "America/Adak"                       : { "UTC-0900", "UTC-1000"},
  "America/Anchorage"                  : { "UTC-0800", "UTC-0900"},
  "America/Anguilla"                   : { "UTC-0400", "UTC-0400"},
  "America/Antigua"                    : { "UTC-0400", "UTC-0400"},
  "America/Araguaina"                  : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Buenos_Aires"     : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Catamarca"        : { "UTC-0300", "UTC-0300"},
  "America/Argentina/ComodRivadavia"   : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Cordoba"          : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Jujuy"            : { "UTC-0300", "UTC-0300"},
  "America/Argentina/La_Rioja"         : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Mendoza"          : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Rio_Gallegos"     : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Salta"            : { "UTC-0300", "UTC-0300"},
  "America/Argentina/San_Juan"         : { "UTC-0300", "UTC-0300"},
  "America/Argentina/San_Luis"         : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Tucuman"          : { "UTC-0300", "UTC-0300"},
  "America/Argentina/Ushuaia"          : { "UTC-0300", "UTC-0300"},
  "America/Aruba"                      : { "UTC-0400", "UTC-0400"},
  "America/Asuncion"                   : { "UTC-0400", "UTC-0300"},
  "America/Atikokan"                   : { "UTC-0500", "UTC-0500"},
  "America/Atka"                       : { "UTC-0900", "UTC-1000"},
  "America/Bahia"                      : { "UTC-0300", "UTC-0300"},
  "America/Bahia_Banderas"             : { "UTC-0500", "UTC-0600"},
  "America/Barbados"                   : { "UTC-0400", "UTC-0400"},
  "America/Belem"                      : { "UTC-0300", "UTC-0300"},
  "America/Belize"                     : { "UTC-0600", "UTC-0600"},
  "America/Blanc-Sablon"               : { "UTC-0400", "UTC-0400"},
  "America/Boa_Vista"                  : { "UTC-0400", "UTC-0400"},
  "America/Bogota"                     : { "UTC-0500", "UTC-0500"},
  "America/Boise"                      : { "UTC-0600", "UTC-0700"},
  "America/Buenos_Aires"               : { "UTC-0300", "UTC-0300"},
  "America/Cambridge_Bay"              : { "UTC-0600", "UTC-0700"},
  "America/Campo_Grande"               : { "UTC-0400", "UTC-0400"},
  "America/Cancun"                     : { "UTC-0500", "UTC-0500"},
  "America/Caracas"                    : { "UTC-0400", "UTC-0400"},
  "America/Catamarca"                  : { "UTC-0300", "UTC-0300"},
  "America/Cayenne"                    : { "UTC-0300", "UTC-0300"},
  "America/Cayman"                     : { "UTC-0500", "UTC-0500"},
  "America/Chicago"                    : { "UTC-0500", "UTC-0600"},
  "America/Chihuahua"                  : { "UTC-0600", "UTC-0700"},
  "America/Coral_Harbour"              : { "UTC-0500", "UTC-0500"},
  "America/Cordoba"                    : { "UTC-0300", "UTC-0300"},
  "America/Costa_Rica"                 : { "UTC-0600", "UTC-0600"},
  "America/Creston"                    : { "UTC-0700", "UTC-0700"},
  "America/Cuiaba"                     : { "UTC-0400", "UTC-0400"},
  "America/Curacao"                    : { "UTC-0400", "UTC-0400"},
  "America/Danmarkshavn"               : { "UTC+0000", "UTC+0000"},
  "America/Dawson"                     : { "UTC-0700", "UTC-0800"},
  "America/Dawson_Creek"               : { "UTC-0700", "UTC-0700"},
  "America/Denver"                     : { "UTC-0600", "UTC-0700"},
  "America/Detroit"                    : { "UTC-0400", "UTC-0500"},
  "America/Dominica"                   : { "UTC-0400", "UTC-0400"},
  "America/Edmonton"                   : { "UTC-0600", "UTC-0700"},
  "America/Eirunepe"                   : { "UTC-0500", "UTC-0500"},
  "America/El_Salvador"                : { "UTC-0600", "UTC-0600"},
  "America/Ensenada"                   : { "UTC-0700", "UTC-0800"},
  "America/Fort_Nelson"                : { "UTC-0700", "UTC-0700"},
  "America/Fort_Wayne"                 : { "UTC-0400", "UTC-0500"},
  "America/Fortaleza"                  : { "UTC-0300", "UTC-0300"},
  "America/Glace_Bay"                  : { "UTC-0300", "UTC-0400"},
  "America/Godthab"                    : { "UTC-0200", "UTC-0300"},
  "America/Goose_Bay"                  : { "UTC-0300", "UTC-0400"},
  "America/Grand_Turk"                 : { "UTC-0400", "UTC-0500"},
  "America/Grenada"                    : { "UTC-0400", "UTC-0400"},
  "America/Guadeloupe"                 : { "UTC-0400", "UTC-0400"},
  "America/Guatemala"                  : { "UTC-0600", "UTC-0600"},
  "America/Guayaquil"                  : { "UTC-0500", "UTC-0500"},
  "America/Guyana"                     : { "UTC-0400", "UTC-0400"},
  "America/Halifax"                    : { "UTC-0300", "UTC-0400"},
  "America/Havana"                     : { "UTC-0400", "UTC-0500"},
  "America/Hermosillo"                 : { "UTC-0700", "UTC-0700"},
  "America/Indiana/Indianapolis"       : { "UTC-0400", "UTC-0500"},
  "America/Indiana/Knox"               : { "UTC-0500", "UTC-0600"},
  "America/Indiana/Marengo"            : { "UTC-0400", "UTC-0500"},
  "America/Indiana/Petersburg"         : { "UTC-0400", "UTC-0500"},
  "America/Indiana/Tell_City"          : { "UTC-0500", "UTC-0600"},
  "America/Indiana/Vevay"              : { "UTC-0400", "UTC-0500"},
  "America/Indiana/Vincennes"          : { "UTC-0400", "UTC-0500"},
  "America/Indiana/Winamac"            : { "UTC-0400", "UTC-0500"},
  "America/Indianapolis"               : { "UTC-0400", "UTC-0500"},
  "America/Inuvik"                     : { "UTC-0600", "UTC-0700"},
  "America/Iqaluit"                    : { "UTC-0400", "UTC-0500"},
  "America/Jamaica"                    : { "UTC-0500", "UTC-0500"},
  "America/Jujuy"                      : { "UTC-0300", "UTC-0300"},
  "America/Juneau"                     : { "UTC-0800", "UTC-0900"},
  "America/Kentucky/Louisville"        : { "UTC-0400", "UTC-0500"},
  "America/Kentucky/Monticello"        : { "UTC-0400", "UTC-0500"},
  "America/Knox_IN"                    : { "UTC-0500", "UTC-0600"},
  "America/Kralendijk"                 : { "UTC-0400", "UTC-0400"},
  "America/La_Paz"                     : { "UTC-0400", "UTC-0400"},
  "America/Lima"                       : { "UTC-0500", "UTC-0500"},
  "America/Los_Angeles"                : { "UTC-0700", "UTC-0800"},
  "America/Louisville"                 : { "UTC-0400", "UTC-0500"},
  "America/Lower_Princes"              : { "UTC-0400", "UTC-0400"},
  "America/Maceio"                     : { "UTC-0300", "UTC-0300"},
  "America/Managua"                    : { "UTC-0600", "UTC-0600"},
  "America/Manaus"                     : { "UTC-0400", "UTC-0400"},
  "America/Marigot"                    : { "UTC-0400", "UTC-0400"},
  "America/Martinique"                 : { "UTC-0400", "UTC-0400"},
  "America/Matamoros"                  : { "UTC-0500", "UTC-0600"},
  "America/Mazatlan"                   : { "UTC-0600", "UTC-0700"},
  "America/Mendoza"                    : { "UTC-0300", "UTC-0300"},
  "America/Menominee"                  : { "UTC-0500", "UTC-0600"},
  "America/Merida"                     : { "UTC-0500", "UTC-0600"},
  "America/Metlakatla"                 : { "UTC-0800", "UTC-0900"},
  "America/Mexico_City"                : { "UTC-0500", "UTC-0600"},
  "America/Miquelon"                   : { "UTC-0200", "UTC-0300"},
  "America/Moncton"                    : { "UTC-0300", "UTC-0400"},
  "America/Monterrey"                  : { "UTC-0500", "UTC-0600"},
  "America/Montevideo"                 : { "UTC-0300", "UTC-0300"},
  "America/Montreal"                   : { "UTC-0400", "UTC-0500"},
  "America/Montserrat"                 : { "UTC-0400", "UTC-0400"},
  "America/Nassau"                     : { "UTC-0400", "UTC-0500"},
  "America/New_York"                   : { "UTC-0400", "UTC-0500"},
  "America/Nipigon"                    : { "UTC-0400", "UTC-0500"},
  "America/Nome"                       : { "UTC-0800", "UTC-0900"},
  "America/Noronha"                    : { "UTC-0200", "UTC-0200"},
  "America/North_Dakota/Beulah"        : { "UTC-0500", "UTC-0600"},
  "America/North_Dakota/Center"        : { "UTC-0500", "UTC-0600"},
  "America/North_Dakota/New_Salem"     : { "UTC-0500", "UTC-0600"},
  "America/Ojinaga"                    : { "UTC-0600", "UTC-0700"},
  "America/Panama"                     : { "UTC-0500", "UTC-0500"},
  "America/Pangnirtung"                : { "UTC-0400", "UTC-0500"},
  "America/Paramaribo"                 : { "UTC-0300", "UTC-0300"},
  "America/Phoenix"                    : { "UTC-0700", "UTC-0700"},
  "America/Port-au-Prince"             : { "UTC-0400", "UTC-0500"},
  "America/Port_of_Spain"              : { "UTC-0400", "UTC-0400"},
  "America/Porto_Acre"                 : { "UTC-0500", "UTC-0500"},
  "America/Porto_Velho"                : { "UTC-0400", "UTC-0400"},
  "America/Puerto_Rico"                : { "UTC-0400", "UTC-0400"},
  "America/Punta_Arenas"               : { "UTC-0300", "UTC-0300"},
  "America/Rainy_River"                : { "UTC-0500", "UTC-0600"},
  "America/Rankin_Inlet"               : { "UTC-0500", "UTC-0600"},
  "America/Recife"                     : { "UTC-0300", "UTC-0300"},
  "America/Regina"                     : { "UTC-0600", "UTC-0600"},
  "America/Resolute"                   : { "UTC-0500", "UTC-0600"},
  "America/Rio_Branco"                 : { "UTC-0500", "UTC-0500"},
  "America/Rosario"                    : { "UTC-0300", "UTC-0300"},
  "America/Santa_Isabel"               : { "UTC-0700", "UTC-0800"},
  "America/Santarem"                   : { "UTC-0300", "UTC-0300"},
  "America/Santiago"                   : { "UTC-0400", "UTC-0300"},
  "America/Santo_Domingo"              : { "UTC-0400", "UTC-0400"},
  "America/Sao_Paulo"                  : { "UTC-0300", "UTC-0300"},
  "America/Scoresbysund"               : { "UTC+0000", "UTC-0100"},
  "America/Shiprock"                   : { "UTC-0600", "UTC-0700"},
  "America/Sitka"                      : { "UTC-0800", "UTC-0900"},
  "America/St_Barthelemy"              : { "UTC-0400", "UTC-0400"},
  "America/St_Johns"                   : { "UTC-0230", "UTC-0330"},
  "America/St_Kitts"                   : { "UTC-0400", "UTC-0400"},
  "America/St_Lucia"                   : { "UTC-0400", "UTC-0400"},
  "America/St_Thomas"                  : { "UTC-0400", "UTC-0400"},
  "America/St_Vincent"                 : { "UTC-0400", "UTC-0400"},
  "America/Swift_Current"              : { "UTC-0600", "UTC-0600"},
  "America/Tegucigalpa"                : { "UTC-0600", "UTC-0600"},
  "America/Thule"                      : { "UTC-0300", "UTC-0400"},
  "America/Thunder_Bay"                : { "UTC-0400", "UTC-0500"},
  "America/Tijuana"                    : { "UTC-0700", "UTC-0800"},
  "America/Toronto"                    : { "UTC-0400", "UTC-0500"},
  "America/Tortola"                    : { "UTC-0400", "UTC-0400"},
  "America/Vancouver"                  : { "UTC-0700", "UTC-0800"},
  "America/Virgin"                     : { "UTC-0400", "UTC-0400"},
  "America/Whitehorse"                 : { "UTC-0700", "UTC-0800"},
  "America/Winnipeg"                   : { "UTC-0500", "UTC-0600"},
  "America/Yakutat"                    : { "UTC-0800", "UTC-0900"},
  "America/Yellowknife"                : { "UTC-0600", "UTC-0700"},
  "Antarctica/Casey"                   : { "UTC+0800", "UTC+0800"},
  "Antarctica/Davis"                   : { "UTC+0700", "UTC+0700"},
  "Antarctica/DumontDUrville"          : { "UTC+1000", "UTC+1000"},
  "Antarctica/Macquarie"               : { "UTC+1100", "UTC+1100"},
  "Antarctica/Mawson"                  : { "UTC+0500", "UTC+0500"},
  "Antarctica/McMurdo"                 : { "UTC+1200", "UTC+1300"},
  "Antarctica/Palmer"                  : { "UTC-0300", "UTC-0300"},
  "Antarctica/Rothera"                 : { "UTC-0300", "UTC-0300"},
  "Antarctica/South_Pole"              : { "UTC+1200", "UTC+1300"},
  "Antarctica/Syowa"                   : { "UTC+0300", "UTC+0300"},
  "Antarctica/Troll"                   : { "UTC+0200", "UTC+0000"},
  "Antarctica/Vostok"                  : { "UTC+0600", "UTC+0600"},
  "Arctic/Longyearbyen"                : { "UTC+0200", "UTC+0100"},
  "Asia/Aden"                          : { "UTC+0300", "UTC+0300"},
  "Asia/Almaty"                        : { "UTC+0600", "UTC+0600"},
  "Asia/Amman"                         : { "UTC+0300", "UTC+0200"},
  "Asia/Anadyr"                        : { "UTC+1200", "UTC+1200"},
  "Asia/Aqtau"                         : { "UTC+0500", "UTC+0500"},
  "Asia/Aqtobe"                        : { "UTC+0500", "UTC+0500"},
  "Asia/Ashgabat"                      : { "UTC+0500", "UTC+0500"},
  "Asia/Ashkhabad"                     : { "UTC+0500", "UTC+0500"},
  "Asia/Atyrau"                        : { "UTC+0500", "UTC+0500"},
  "Asia/Baghdad"                       : { "UTC+0300", "UTC+0300"},
  "Asia/Bahrain"                       : { "UTC+0300", "UTC+0300"},
  "Asia/Baku"                          : { "UTC+0400", "UTC+0400"},
  "Asia/Bangkok"                       : { "UTC+0700", "UTC+0700"},
  "Asia/Barnaul"                       : { "UTC+0700", "UTC+0700"},
  "Asia/Beirut"                        : { "UTC+0300", "UTC+0200"},
  "Asia/Bishkek"                       : { "UTC+0600", "UTC+0600"},
  "Asia/Brunei"                        : { "UTC+0800", "UTC+0800"},
  "Asia/Calcutta"                      : { "UTC+0530", "UTC+0530"},
  "Asia/Chita"                         : { "UTC+0900", "UTC+0900"},
  "Asia/Choibalsan"                    : { "UTC+0800", "UTC+0800"},
  "Asia/Chongqing"                     : { "UTC+0800", "UTC+0800"},
  "Asia/Chungking"                     : { "UTC+0800", "UTC+0800"},
  "Asia/Colombo"                       : { "UTC+0530", "UTC+0530"},
  "Asia/Dacca"                         : { "UTC+0600", "UTC+0600"},
  "Asia/Damascus"                      : { "UTC+0300", "UTC+0200"},
  "Asia/Dhaka"                         : { "UTC+0600", "UTC+0600"},
  "Asia/Dili"                          : { "UTC+0900", "UTC+0900"},
  "Asia/Dubai"                         : { "UTC+0400", "UTC+0400"},
  "Asia/Dushanbe"                      : { "UTC+0500", "UTC+0500"},
  "Asia/Famagusta"                     : { "UTC+0300", "UTC+0200"},
  "Asia/Gaza"                          : { "UTC+0300", "UTC+0200"},
  "Asia/Harbin"                        : { "UTC+0800", "UTC+0800"},
  "Asia/Hebron"                        : { "UTC+0300", "UTC+0200"},
  "Asia/Ho_Chi_Minh"                   : { "UTC+0700", "UTC+0700"},
  "Asia/Hong_Kong"                     : { "UTC+0800", "UTC+0800"},
  "Asia/Hovd"                          : { "UTC+0700", "UTC+0700"},
  "Asia/Irkutsk"                       : { "UTC+0800", "UTC+0800"},
  "Asia/Istanbul"                      : { "UTC+0300", "UTC+0300"},
  "Asia/Jakarta"                       : { "UTC+0700", "UTC+0700"},
  "Asia/Jayapura"                      : { "UTC+0900", "UTC+0900"},
  "Asia/Jerusalem"                     : { "UTC+0300", "UTC+0200"},
  "Asia/Kabul"                         : { "UTC+0430", "UTC+0430"},
  "Asia/Kamchatka"                     : { "UTC+1200", "UTC+1200"},
  "Asia/Karachi"                       : { "UTC+0500", "UTC+0500"},
  "Asia/Kashgar"                       : { "UTC+0600", "UTC+0600"},
  "Asia/Kathmandu"                     : { "UTC+0545", "UTC+0545"},
  "Asia/Katmandu"                      : { "UTC+0545", "UTC+0545"},
  "Asia/Khandyga"                      : { "UTC+0900", "UTC+0900"},
  "Asia/Kolkata"                       : { "UTC+0530", "UTC+0530"},
  "Asia/Krasnoyarsk"                   : { "UTC+0700", "UTC+0700"},
  "Asia/Kuala_Lumpur"                  : { "UTC+0800", "UTC+0800"},
  "Asia/Kuching"                       : { "UTC+0800", "UTC+0800"},
  "Asia/Kuwait"                        : { "UTC+0300", "UTC+0300"},
  "Asia/Macao"                         : { "UTC+0800", "UTC+0800"},
  "Asia/Macau"                         : { "UTC+0800", "UTC+0800"},
  "Asia/Magadan"                       : { "UTC+1100", "UTC+1100"},
  "Asia/Makassar"                      : { "UTC+0800", "UTC+0800"},
  "Asia/Manila"                        : { "UTC+0800", "UTC+0800"},
  "Asia/Muscat"                        : { "UTC+0400", "UTC+0400"},
  "Asia/Nicosia"                       : { "UTC+0300", "UTC+0200"},
  "Asia/Novokuznetsk"                  : { "UTC+0700", "UTC+0700"},
  "Asia/Novosibirsk"                   : { "UTC+0700", "UTC+0700"},
  "Asia/Omsk"                          : { "UTC+0600", "UTC+0600"},
  "Asia/Oral"                          : { "UTC+0500", "UTC+0500"},
  "Asia/Phnom_Penh"                    : { "UTC+0700", "UTC+0700"},
  "Asia/Pontianak"                     : { "UTC+0700", "UTC+0700"},
  "Asia/Pyongyang"                     : { "UTC+0900", "UTC+0900"},
  "Asia/Qatar"                         : { "UTC+0300", "UTC+0300"},
  "Asia/Qostanay"                      : { "UTC+0600", "UTC+0600"},
  "Asia/Qyzylorda"                     : { "UTC+0500", "UTC+0500"},
  "Asia/Rangoon"                       : { "UTC+0630", "UTC+0630"},
  "Asia/Riyadh"                        : { "UTC+0300", "UTC+0300"},
  "Asia/Saigon"                        : { "UTC+0700", "UTC+0700"},
  "Asia/Sakhalin"                      : { "UTC+1100", "UTC+1100"},
  "Asia/Samarkand"                     : { "UTC+0500", "UTC+0500"},
  "Asia/Seoul"                         : { "UTC+0900", "UTC+0900"},
  "Asia/Shanghai"                      : { "UTC+0800", "UTC+0800"},
  "Asia/Singapore"                     : { "UTC+0800", "UTC+0800"},
  "Asia/Srednekolymsk"                 : { "UTC+1100", "UTC+1100"},
  "Asia/Taipei"                        : { "UTC+0800", "UTC+0800"},
  "Asia/Tashkent"                      : { "UTC+0500", "UTC+0500"},
  "Asia/Tbilisi"                       : { "UTC+0400", "UTC+0400"},
  "Asia/Tehran"                        : { "UTC+0430", "UTC+0330"},
  "Asia/Tel_Aviv"                      : { "UTC+0300", "UTC+0200"},
  "Asia/Thimbu"                        : { "UTC+0600", "UTC+0600"},
  "Asia/Thimphu"                       : { "UTC+0600", "UTC+0600"},
  "Asia/Tokyo"                         : { "UTC+0900", "UTC+0900"},
  "Asia/Tomsk"                         : { "UTC+0700", "UTC+0700"},
  "Asia/Ujung_Pandang"                 : { "UTC+0800", "UTC+0800"},
  "Asia/Ulaanbaatar"                   : { "UTC+0800", "UTC+0800"},
  "Asia/Ulan_Bator"                    : { "UTC+0800", "UTC+0800"},
  "Asia/Urumqi"                        : { "UTC+0600", "UTC+0600"},
  "Asia/Ust-Nera"                      : { "UTC+1000", "UTC+1000"},
  "Asia/Vientiane"                     : { "UTC+0700", "UTC+0700"},
  "Asia/Vladivostok"                   : { "UTC+1000", "UTC+1000"},
  "Asia/Yakutsk"                       : { "UTC+0900", "UTC+0900"},
  "Asia/Yangon"                        : { "UTC+0630", "UTC+0630"},
  "Asia/Yekaterinburg"                 : { "UTC+0500", "UTC+0500"},
  "Asia/Yerevan"                       : { "UTC+0400", "UTC+0400"},
  "Atlantic/Azores"                    : { "UTC+0000", "UTC-0100"},
  "Atlantic/Bermuda"                   : { "UTC-0300", "UTC-0400"},
  "Atlantic/Canary"                    : { "UTC+0100", "UTC+0000"},
  "Atlantic/Cape_Verde"                : { "UTC-0100", "UTC-0100"},
  "Atlantic/Faeroe"                    : { "UTC+0100", "UTC+0000"},
  "Atlantic/Faroe"                     : { "UTC+0100", "UTC+0000"},
  "Atlantic/Jan_Mayen"                 : { "UTC+0200", "UTC+0100"},
  "Atlantic/Madeira"                   : { "UTC+0100", "UTC+0000"},
  "Atlantic/Reykjavik"                 : { "UTC+0000", "UTC+0000"},
  "Atlantic/South_Georgia"             : { "UTC-0200", "UTC-0200"},
  "Atlantic/St_Helena"                 : { "UTC+0000", "UTC+0000"},
  "Atlantic/Stanley"                   : { "UTC-0300", "UTC-0300"},
  "Australia/ACT"                      : { "UTC+1000", "UTC+1100"},
  "Australia/Adelaide"                 : { "UTC+0930", "UTC+1030"},
  "Australia/Brisbane"                 : { "UTC+1000", "UTC+1000"},
  "Australia/Broken_Hill"              : { "UTC+0930", "UTC+1030"},
  "Australia/Canberra"                 : { "UTC+1000", "UTC+1100"},
  "Australia/Currie"                   : { "UTC+1000", "UTC+1100"},
  "Australia/Darwin"                   : { "UTC+0930", "UTC+0930"},
  "Australia/Eucla"                    : { "UTC+0845", "UTC+0845"},
  "Australia/Hobart"                   : { "UTC+1000", "UTC+1100"},
  "Australia/LHI"                      : { "UTC+1030", "UTC+1100"},
  "Australia/Lindeman"                 : { "UTC+1000", "UTC+1000"},
  "Australia/Lord_Howe"                : { "UTC+1030", "UTC+1100"},
  "Australia/Melbourne"                : { "UTC+1000", "UTC+1100"},
  "Australia/NSW"                      : { "UTC+1000", "UTC+1100"},
  "Australia/North"                    : { "UTC+0930", "UTC+0930"},
  "Australia/Perth"                    : { "UTC+0800", "UTC+0800"},
  "Australia/Queensland"               : { "UTC+1000", "UTC+1000"},
  "Australia/South"                    : { "UTC+0930", "UTC+1030"},
  "Australia/Sydney"                   : { "UTC+1000", "UTC+1100"},
  "Australia/Tasmania"                 : { "UTC+1000", "UTC+1100"},
  "Australia/Victoria"                 : { "UTC+1000", "UTC+1100"},
  "Australia/West"                     : { "UTC+0800", "UTC+0800"},
  "Australia/Yancowinna"               : { "UTC+0930", "UTC+1030"},
  "Brazil/Acre"                        : { "UTC-0500", "UTC-0500"},
  "Brazil/DeNoronha"                   : { "UTC-0200", "UTC-0200"},
  "Brazil/East"                        : { "UTC-0300", "UTC-0300"},
  "Brazil/West"                        : { "UTC-0400", "UTC-0400"},
  "CET"                                : { "UTC+0200", "UTC+0100"},
  "CST6CDT"                            : { "UTC-0500", "UTC-0600"},
  "Canada/Atlantic"                    : { "UTC-0300", "UTC-0400"},
  "Canada/Central"                     : { "UTC-0500", "UTC-0600"},
  "Canada/Eastern"                     : { "UTC-0400", "UTC-0500"},
  "Canada/Mountain"                    : { "UTC-0600", "UTC-0700"},
  "Canada/Newfoundland"                : { "UTC-0230", "UTC-0330"},
  "Canada/Pacific"                     : { "UTC-0700", "UTC-0800"},
  "Canada/Saskatchewan"                : { "UTC-0600", "UTC-0600"},
  "Canada/Yukon"                       : { "UTC-0700", "UTC-0800"},
  "Chile/Continental"                  : { "UTC-0400", "UTC-0300"},
  "Chile/EasterIsland"                 : { "UTC-0600", "UTC-0500"},
  "Cuba"                               : { "UTC-0400", "UTC-0500"},
  "EET"                                : { "UTC+0300", "UTC+0200"},
  "EST"                                : { "UTC-0500", "UTC-0500"},
  "EST5EDT"                            : { "UTC-0400", "UTC-0500"},
  "Egypt"                              : { "UTC+0200", "UTC+0200"},
  "Eire"                               : { "UTC+0100", "UTC+0000"},
  "Etc/GMT"                            : { "UTC+0000", "UTC+0000"},
  "Etc/GMT+0"                          : { "UTC+0000", "UTC+0000"},
  "Etc/GMT+1"                          : { "UTC-0100", "UTC-0100"},
  "Etc/GMT+10"                         : { "UTC-1000", "UTC-1000"},
  "Etc/GMT+11"                         : { "UTC-1100", "UTC-1100"},
  "Etc/GMT+12"                         : { "UTC-1200", "UTC-1200"},
  "Etc/GMT+2"                          : { "UTC-0200", "UTC-0200"},
  "Etc/GMT+3"                          : { "UTC-0300", "UTC-0300"},
  "Etc/GMT+4"                          : { "UTC-0400", "UTC-0400"},
  "Etc/GMT+5"                          : { "UTC-0500", "UTC-0500"},
  "Etc/GMT+6"                          : { "UTC-0600", "UTC-0600"},
  "Etc/GMT+7"                          : { "UTC-0700", "UTC-0700"},
  "Etc/GMT+8"                          : { "UTC-0800", "UTC-0800"},
  "Etc/GMT+9"                          : { "UTC-0900", "UTC-0900"},
  "Etc/GMT-0"                          : { "UTC+0000", "UTC+0000"},
  "Etc/GMT-1"                          : { "UTC+0100", "UTC+0100"},
  "Etc/GMT-10"                         : { "UTC+1000", "UTC+1000"},
  "Etc/GMT-11"                         : { "UTC+1100", "UTC+1100"},
  "Etc/GMT-12"                         : { "UTC+1200", "UTC+1200"},
  "Etc/GMT-13"                         : { "UTC+1300", "UTC+1300"},
  "Etc/GMT-14"                         : { "UTC+1400", "UTC+1400"},
  "Etc/GMT-2"                          : { "UTC+0200", "UTC+0200"},
  "Etc/GMT-3"                          : { "UTC+0300", "UTC+0300"},
  "Etc/GMT-4"                          : { "UTC+0400", "UTC+0400"},
  "Etc/GMT-5"                          : { "UTC+0500", "UTC+0500"},
  ...
  "Etc/GMT-8"                          : { "UTC+0800", "UTC+0800"},
  "Etc/GMT-9"                          : { "UTC+0900", "UTC+0900"},
  "Etc/GMT0"                           : { "UTC+0000", "UTC+0000"},
  "Etc/Greenwich"                      : { "UTC+0000", "UTC+0000"},
  "Etc/UCT"                            : { "UTC+0000", "UTC+0000"},
  "Etc/UTC"                            : { "UTC+0000", "UTC+0000"},
  "Etc/Universal"                      : { "UTC+0000", "UTC+0000"},
  "Etc/Zulu"                           : { "UTC+0000", "UTC+0000"},
  "Europe/Amsterdam"                   : { "UTC+0200", "UTC+0100"},
  "Europe/Andorra"                     : { "UTC+0200", "UTC+0100"},
  "Europe/Astrakhan"                   : { "UTC+0400", "UTC+0400"},
  "Europe/Athens"                      : { "UTC+0300", "UTC+0200"},
  "Europe/Belfast"                     : { "UTC+0100", "UTC+0000"},
  "Europe/Belgrade"                    : { "UTC+0200", "UTC+0100"},
  "Europe/Berlin"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Bratislava"                  : { "UTC+0200", "UTC+0100"},
  "Europe/Brussels"                    : { "UTC+0200", "UTC+0100"},
  "Europe/Bucharest"                   : { "UTC+0300", "UTC+0200"},
  "Europe/Budapest"                    : { "UTC+0200", "UTC+0100"},
  "Europe/Busingen"                    : { "UTC+0200", "UTC+0100"},
  "Europe/Chisinau"                    : { "UTC+0300", "UTC+0200"},
  "Europe/Copenhagen"                  : { "UTC+0200", "UTC+0100"},
  "Europe/Dublin"                      : { "UTC+0100", "UTC+0000"},
  "Europe/Gibraltar"                   : { "UTC+0200", "UTC+0100"},
  "Europe/Guernsey"                    : { "UTC+0100", "UTC+0000"},
  "Europe/Helsinki"                    : { "UTC+0300", "UTC+0200"},
  "Europe/Isle_of_Man"                 : { "UTC+0100", "UTC+0000"},
  "Europe/Istanbul"                    : { "UTC+0300", "UTC+0300"},
  "Europe/Jersey"                      : { "UTC+0100", "UTC+0000"},
  "Europe/Kaliningrad"                 : { "UTC+0200", "UTC+0200"},
  "Europe/Kiev"                        : { "UTC+0300", "UTC+0200"},
  "Europe/Kirov"                       : { "UTC+0300", "UTC+0300"},
  "Europe/Lisbon"                      : { "UTC+0100", "UTC+0000"},
  "Europe/Ljubljana"                   : { "UTC+0200", "UTC+0100"},
  "Europe/London"                      : { "UTC+0100", "UTC+0000"},
  "Europe/Luxembourg"                  : { "UTC+0200", "UTC+0100"},
  "Europe/Madrid"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Malta"                       : { "UTC+0200", "UTC+0100"},
  "Europe/Mariehamn"                   : { "UTC+0300", "UTC+0200"},
  "Europe/Minsk"                       : { "UTC+0300", "UTC+0300"},
  "Europe/Monaco"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Moscow"                      : { "UTC+0300", "UTC+0300"},
  "Europe/Nicosia"                     : { "UTC+0300", "UTC+0200"},
  "Europe/Oslo"                        : { "UTC+0200", "UTC+0100"},
  "Europe/Paris"                       : { "UTC+0200", "UTC+0100"},
  "Europe/Podgorica"                   : { "UTC+0200", "UTC+0100"},
  "Europe/Prague"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Riga"                        : { "UTC+0300", "UTC+0200"},
  "Europe/Rome"                        : { "UTC+0200", "UTC+0100"},
  "Europe/Samara"                      : { "UTC+0400", "UTC+0400"},
  "Europe/San_Marino"                  : { "UTC+0200", "UTC+0100"},
  "Europe/Sarajevo"                    : { "UTC+0200", "UTC+0100"},
  "Europe/Saratov"                     : { "UTC+0400", "UTC+0400"},
  "Europe/Simferopol"                  : { "UTC+0300", "UTC+0300"},
  "Europe/Skopje"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Sofia"                       : { "UTC+0300", "UTC+0200"},
  "Europe/Stockholm"                   : { "UTC+0200", "UTC+0100"},
  "Europe/Tallinn"                     : { "UTC+0300", "UTC+0200"},
  "Europe/Tirane"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Tiraspol"                    : { "UTC+0300", "UTC+0200"},
  "Europe/Ulyanovsk"                   : { "UTC+0400", "UTC+0400"},
  "Europe/Uzhgorod"                    : { "UTC+0300", "UTC+0200"},
  "Europe/Vaduz"                       : { "UTC+0200", "UTC+0100"},
  "Europe/Vatican"                     : { "UTC+0200", "UTC+0100"},
  "Europe/Vienna"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Vilnius"                     : { "UTC+0300", "UTC+0200"},
  "Europe/Volgograd"                   : { "UTC+0400", "UTC+0400"},
  "Europe/Warsaw"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Zagreb"                      : { "UTC+0200", "UTC+0100"},
  "Europe/Zaporozhye"                  : { "UTC+0300", "UTC+0200"},
  "Europe/Zurich"                      : { "UTC+0200", "UTC+0100"},
  "Factory"                            : { "UTC+0000", "UTC+0000"},
  "GB"                                 : { "UTC+0100", "UTC+0000"},
  "GB-Eire"                            : { "UTC+0100", "UTC+0000"},
  "GMT"                                : { "UTC+0000", "UTC+0000"},
  "GMT+0"                              : { "UTC+0000", "UTC+0000"},
  "GMT-0"                              : { "UTC+0000", "UTC+0000"},
  "GMT0"                               : { "UTC+0000", "UTC+0000"},
  "Greenwich"                          : { "UTC+0000", "UTC+0000"},
  "HST"                                : { "UTC-1000", "UTC-1000"},
  "Hongkong"                           : { "UTC+0800", "UTC+0800"},
  "Iceland"                            : { "UTC+0000", "UTC+0000"},
  "Indian/Antananarivo"                : { "UTC+0300", "UTC+0300"},
  "Indian/Chagos"                      : { "UTC+0600", "UTC+0600"},
  "Indian/Christmas"                   : { "UTC+0700", "UTC+0700"},
  "Indian/Cocos"                       : { "UTC+0630", "UTC+0630"},
  "Indian/Comoro"                      : { "UTC+0300", "UTC+0300"},
  "Indian/Kerguelen"                   : { "UTC+0500", "UTC+0500"},
  "Indian/Mahe"                        : { "UTC+0400", "UTC+0400"},
  "Indian/Maldives"                    : { "UTC+0500", "UTC+0500"},
  "Indian/Mauritius"                   : { "UTC+0400", "UTC+0400"},
  "Indian/Mayotte"                     : { "UTC+0300", "UTC+0300"},
  "Indian/Reunion"                     : { "UTC+0400", "UTC+0400"},
  "Iran"                               : { "UTC+0430", "UTC+0330"},
  "Israel"                             : { "UTC+0300", "UTC+0200"},
  "Jamaica"                            : { "UTC-0500", "UTC-0500"},
  "Japan"                              : { "UTC+0900", "UTC+0900"},
  "Kwajalein"                          : { "UTC+1200", "UTC+1200"},
  "Libya"                              : { "UTC+0200", "UTC+0200"},
  "MET"                                : { "UTC+0200", "UTC+0100"},
  "MST"                                : { "UTC-0700", "UTC-0700"},
  "MST7MDT"                            : { "UTC-0600", "UTC-0700"},
  "Mexico/BajaNorte"                   : { "UTC-0700", "UTC-0800"},
  "Mexico/BajaSur"                     : { "UTC-0600", "UTC-0700"},
  "Mexico/General"                     : { "UTC-0500", "UTC-0600"},
  "NZ"                                 : { "UTC+1200", "UTC+1300"},
  "NZ-CHAT"                            : { "UTC+1245", "UTC+1345"},
  "Navajo"                             : { "UTC-0600", "UTC-0700"},
  "PRC"                                : { "UTC+0800", "UTC+0800"},
  "PST8PDT"                            : { "UTC-0700", "UTC-0800"},
  "Pacific/Apia"                       : { "UTC+1300", "UTC+1400"},
  "Pacific/Auckland"                   : { "UTC+1200", "UTC+1300"},
  "Pacific/Bougainville"               : { "UTC+1100", "UTC+1100"},
  "Pacific/Chatham"                    : { "UTC+1245", "UTC+1345"},
  "Pacific/Chuuk"                      : { "UTC+1000", "UTC+1000"},
  "Pacific/Easter"                     : { "UTC-0600", "UTC-0500"},
  "Pacific/Efate"                      : { "UTC+1100", "UTC+1100"},
  "Pacific/Enderbury"                  : { "UTC+1300", "UTC+1300"},
  "Pacific/Fakaofo"                    : { "UTC+1300", "UTC+1300"},
  "Pacific/Fiji"                       : { "UTC+1200", "UTC+1300"},
  "Pacific/Funafuti"                   : { "UTC+1200", "UTC+1200"},
  "Pacific/Galapagos"                  : { "UTC-0600", "UTC-0600"},
  "Pacific/Gambier"                    : { "UTC-0900", "UTC-0900"},
  "Pacific/Guadalcanal"                : { "UTC+1100", "UTC+1100"},
  "Pacific/Guam"                       : { "UTC+1000", "UTC+1000"},
  "Pacific/Honolulu"                   : { "UTC-1000", "UTC-1000"},
  "Pacific/Johnston"                   : { "UTC-1000", "UTC-1000"},
  "Pacific/Kiritimati"                 : { "UTC+1400", "UTC+1400"},
  "Pacific/Kosrae"                     : { "UTC+1100", "UTC+1100"},
  "Pacific/Kwajalein"                  : { "UTC+1200", "UTC+1200"},
  "Pacific/Majuro"                     : { "UTC+1200", "UTC+1200"},
  "Pacific/Marquesas"                  : { "UTC-0930", "UTC-0930"},
  "Pacific/Midway"                     : { "UTC-1100", "UTC-1100"},
  "Pacific/Nauru"                      : { "UTC+1200", "UTC+1200"},
  "Pacific/Niue"                       : { "UTC-1100", "UTC-1100"},
  "Pacific/Norfolk"                    : { "UTC+1100", "UTC+1100"},
  "Pacific/Noumea"                     : { "UTC+1100", "UTC+1100"},
  "Pacific/Pago_Pago"                  : { "UTC-1100", "UTC-1100"},
  "Pacific/Palau"                      : { "UTC+0900", "UTC+0900"},
  "Pacific/Pitcairn"                   : { "UTC-0800", "UTC-0800"},
  "Pacific/Pohnpei"                    : { "UTC+1100", "UTC+1100"},
  "Pacific/Ponape"                     : { "UTC+1100", "UTC+1100"},
  "Pacific/Port_Moresby"               : { "UTC+1000", "UTC+1000"},
  "Pacific/Rarotonga"                  : { "UTC-1000", "UTC-1000"},
  "Pacific/Saipan"                     : { "UTC+1000", "UTC+1000"},
  "Pacific/Samoa"                      : { "UTC-1100", "UTC-1100"},
  "Pacific/Tahiti"                     : { "UTC-1000", "UTC-1000"},
  "Pacific/Tarawa"                     : { "UTC+1200", "UTC+1200"},
  "Pacific/Tongatapu"                  : { "UTC+1300", "UTC+1300"},
  "Pacific/Truk"                       : { "UTC+1000", "UTC+1000"},
  "Pacific/Wake"                       : { "UTC+1200", "UTC+1200"},
  "Pacific/Wallis"                     : { "UTC+1200", "UTC+1200"},
  "Pacific/Yap"                        : { "UTC+1000", "UTC+1000"},
  "Poland"                             : { "UTC+0200", "UTC+0100"},
  "Portugal"                           : { "UTC+0100", "UTC+0000"},
  "ROC"                                : { "UTC+0800", "UTC+0800"},
  "ROK"                                : { "UTC+0900", "UTC+0900"},
  "Singapore"                          : { "UTC+0800", "UTC+0800"},
  "Turkey"                             : { "UTC+0300", "UTC+0300"},
  "UCT"                                : { "UTC+0000", "UTC+0000"},
  "US/Alaska"                          : { "UTC-0800", "UTC-0900"},
  "US/Aleutian"                        : { "UTC-0900", "UTC-1000"},
  "US/Arizona"                         : { "UTC-0700", "UTC-0700"},
  "US/Central"                         : { "UTC-0500", "UTC-0600"},
  "US/East-Indiana"                    : { "UTC-0400", "UTC-0500"},
  "US/Eastern"                         : { "UTC-0400", "UTC-0500"},
  "US/Hawaii"                          : { "UTC-1000", "UTC-1000"},
  "US/Indiana-Starke"                  : { "UTC-0500", "UTC-0600"},
  "US/Michigan"                        : { "UTC-0400", "UTC-0500"},
  "US/Mountain"                        : { "UTC-0600", "UTC-0700"},
  "US/Pacific"                         : { "UTC-0700", "UTC-0800"},
  "US/Samoa"                           : { "UTC-1100", "UTC-1100"},
  "UTC"                                : { "UTC+0000", "UTC+0000"},
  "Universal"                          : { "UTC+0000", "UTC+0000"},
  "W-SU"                               : { "UTC+0300", "UTC+0300"},
  "WET"                                : { "UTC+0100", "UTC+0000"},
  "Zulu"                               : { "UTC+0000", "UTC+0000"},
  "Alpha"                              : { "UTC+0100", "UTC+0100"},
  "Bravo"                              : { "UTC+0200", "UTC+0200"},
  "Charlie"                            : { "UTC+0300", "UTC+0300"},
  "Delta"                              : { "UTC+0400", "UTC+0400"},
  "Echo"                               : { "UTC+0500", "UTC+0500"},
  "Foxtrot"                            : { "UTC+0600", "UTC+0600"},
  "Golf"                               : { "UTC+0700", "UTC+0700"},
  "Hotel"                              : { "UTC+0800", "UTC+0800"},
  "India"                              : { "UTC+0900", "UTC+0900"},
  "Kilo"                               : { "UTC+1000", "UTC+1000"},
  "Lima"                               : { "UTC+1100", "UTC+1100"},
  "Mike"                               : { "UTC+1200", "UTC+1200"},
  "November"                           : { "UTC-0100", "UTC-0100"},
  "Oscar"                              : { "UTC-0200", "UTC-0200"},
  "Papa"                               : { "UTC-0300", "UTC-0300"},
  "Quebec"                             : { "UTC-0400", "UTC-0400"},
  "Romeo"                              : { "UTC-0500", "UTC-0500"},
  "Sierra"                             : { "UTC-0600", "UTC-0600"},
  "Tango"                              : { "UTC-0700", "UTC-0700"},
