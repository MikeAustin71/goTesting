...
func main() {
	...
	_,
	err :=
	revisedJulianDateToJulianDayNumber(
		startYear,
		startMonth,
		startDay,
		startHour,
...
func revisedJulianDateToJulianDayNumber(
	startYear int64,
	startMonth,
	startDay,
	startHours,
	...
	ePrefix := "revisedJulianDateToJulianDayNumber() "
 ...
 */
	...
	//fmt.Printf("First Cacl endingOrdinalDays: %v\n",
	//	endingOrdinalDays)
	//
	//fmt.Printf("First Cacl targetYear: %v\n",
	//	targetYear)
	//
	//fmt.Printf("First Cacl targetMonth: %v\n",
	//	targetMonth)
	//
	//
	//fmt.Printf("First Cacl targetDay: %v\n\n",
	//	targetDay)
