...
func (dateTimeTransDto *DateTimeTransferDto) Compare(
	...
	if dateTimeTransDto.year == dateTimeTransDto2.year {
		...
		timeTransDtoOrdinalDays, err = calMech2.GetOrdinalDayNumber(
		...
		timeTrans2OrdinalDays, err = calMech2.GetOrdinalDayNumber(
...
// GetRemainingDaysOfYear - Returns an integer value identifying the number
// of days remaining in the year based on the date/time encapsulated by
// current DateTimeTransferDto instance.
//
...
//
//
func (dateTimeTransDto *DateTimeTransferDto) GetRemainingDaysOfYear(
	ePrefix string) (
...
// GetYear - Returns the the number of days in the year specified by
// the current DateTimeTransferDto instance.
//
