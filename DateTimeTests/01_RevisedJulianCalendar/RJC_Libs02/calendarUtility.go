...
// and a target date/time. To guarantee complete accuracy, the input DateTimeTransferDto
...
// Input Parameters
//
// baseDateTimeDto          DateTimeTransferDto
...
func (calUtil *CalendarUtility) GetCompleteYearInterval(
	...
	var tempBaseDateTimeDto, tempTargetDateTimeDto DateTimeTransferDto
...
//       be populated with one of two values: Zero (0) or Minus
//       One (-1). A value of Zero signals that no year adjustment
//       is required. A value of Minus One indicates that the ordinal
//       date represents December 31st of the prior year, thereby
//       signaling that an adjustment to the original year value
//       is necessary.
//
//  month             int
