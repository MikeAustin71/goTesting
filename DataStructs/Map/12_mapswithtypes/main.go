...
"MSK+0400"      :{"MSK+0400","MSK","Moscow Standard Time","Europe","+0400",""},
...
func main () {
	...
	abbrvDto, ok := m["CST-0600"]

	if !ok {
		fmt.Printf("Could NOT locate CST-0600!\n")
		return
	}

	fmt.Println("Tz Name: ", abbrvDto.TzName, "\t Id: ", abbrvDto.Id)
